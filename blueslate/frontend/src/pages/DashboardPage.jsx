    ...
    return (
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
                ...
                <Link
                    to="/leads"
                    className="hidden sm:flex items-center gap-1.5 text-sm px-3.5 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-medium transition-colors shadow-sm shadow-blue-200 dark:shadow-blue-900/50"
                >
                    <Users size={15} />
                    Manage Leads
                </Link>
            ...
            {!loading && !error && stats && (
                <>
                    ...
                    {/* Empty state */}
                    {leads.length === 0 && (
                        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-dashed border-gray-300 dark:border-gray-700 shadow-sm px-8 py-16 flex flex-col items-center text-center gap-5">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1.5 max-w-xs">
                                    Your AI receptionist will start capturing leads automatically when visitors share their contact details.
                                </p>
                            </div>
                            <Link
                                to="/receptionist"
                                className="flex items-center gap-2 text-sm px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-medium transition-colors shadow-sm shadow-blue-200 dark:shadow-blue-900/50"
                            >
                                <PhoneCall size={15} />
                                Launch Receptionist
                            </Link>
